      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-secondary-lavender">Empowering small businesses with AI-driven storytelling.</p>
          </div>
          <div>
            <h4 className="font-heading text-lg font-semibold mb-4">Quick Links</h4>
            <ul className="space-y-2">
              <li><Link href="/terms" className="hover:text-accent transition-colors duration-300">Terms & Conditions</Link></li>
              <li><Link href="/privacy" className="hover:text-accent transition-colors duration-300">Privacy Policy</Link></li>
              <li><Link href="/contact" className="hover:text-accent transition-colors duration-300">Contact Us</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 border-t border-white/20 text-center">
          <p className="text-secondary-lavender">&copy; {new Date().getFullYear()} TailorTales. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
